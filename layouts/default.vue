  ...
  <Menubar id="main-menubar" :pt="{
    ...
    <template #start>
      <div class="hidden md:block">
        <div class="flex flex-row flex-wrap">
          <NuxtLink to="/" class="flex align-items-center flex-wrap logo-link">
            <div class="w-15rem flex align-items-center flex-wrap">
              ...
              <span class="font-semibold text-2xl text-primary ml-3">YES AI Market</span>
            </div>
          </NuxtLink>
          <div class="">
            <Button icon="pi pi-bars" severity="secondary" aria-label="Menu" text @click="menuMain = !menuMain"
              class="mr-2" />
          </div>
        </div>
      </div>
      ...
      <div class="block md:hidden">
        <div class="grid">
          <div class="col-fixed" style="width: 35px">
            <Button icon="pi pi-bars" severity="secondary" aria-label="Bookmark" text
    ...
    <template #end>
      <div class="flex align-items-center gap-2">
        <LanguageSwitcher />
        <Button :icon="isDark ? 'pi pi-sun' : 'pi pi-moon'" severity="secondary" aria-label="Toggle theme" text
          @click="toggleTheme" />
        <Button icon="pi pi-bars" text rounded severity="secondary" @click="menuMainMobile = true" class="md:hidden" />
        <Avatar image="https://primefaces.org/cdn/primevue/images/avatar/amyelsner.png" shape="circle"
          @click="toggleMenuProfile" aria-haspopup="true" aria-controls="overlay_menu" />
